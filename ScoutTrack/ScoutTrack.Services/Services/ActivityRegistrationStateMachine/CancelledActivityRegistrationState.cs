...
{
    public class CancelledActivityRegistrationState : BaseActivityRegistrationState
    {
        public CancelledActivityRegistrationState(IServiceProvider serviceProvider, ScoutTrackDbContext context, IMapper mapper) 
            : base(serviceProvider, context, mapper)
        {
        }

        // Cancelled registrations can be updated to change status back to pending for reconsideration
