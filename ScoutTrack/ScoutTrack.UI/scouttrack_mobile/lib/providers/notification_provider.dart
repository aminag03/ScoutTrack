...
class NotificationProvider extends BaseProvider<Notification, dynamic> {
  ...
  Future<List<Notification>> sendNotificationsToUsers({
    ...
    return await handleWithRefresh(() async {
      final uri = Uri.parse("${BaseProvider.baseUrl}$endpoint/send-to-users");
  ...
  Future<bool> markAsRead(int id) async {
    return await handleWithRefresh(() async {
      final uri = Uri.parse(
        "${BaseProvider.baseUrl}$endpoint/$id/mark-as-read",
      );
      final headers = await createHeaders();
  ...
  Future<bool> markAllAsRead() async {
    return await handleWithRefresh(() async {
      final uri = Uri.parse(
        "${BaseProvider.baseUrl}$endpoint/mark-all-as-read",
      );
      final headers = await createHeaders();
  ...
  Future<int> getUnreadCount() async {
    return await handleWithRefresh(() async {
      final uri = Uri.parse("${BaseProvider.baseUrl}$endpoint/unread-count");
      final headers = await createHeaders();
  ...
  Future<bool> deleteNotification(int id) async {
    return await handleWithRefresh(() async {
      final uri = Uri.parse("${BaseProvider.baseUrl}$endpoint/$id");
      final headers = await createHeaders();
  ...
  Future<bool> deleteAllNotifications() async {
    return await handleWithRefresh(() async {
      final uri = Uri.parse("${BaseProvider.baseUrl}$endpoint/delete-all");
      final headers = await createHeaders();
  ...
  Future<SearchResult<Notification>> getMyNotifications({
    ...
    return await handleWithRefresh(() async {
      var uri = Uri.parse("${BaseProvider.baseUrl}$endpoint/my-notifications");
      final headers = await createHeaders();
