...
Activity _$ActivityFromJson(Map<String, dynamic> json) => Activity(
  ...
  pendingRegistrationCount:
      (json['pendingRegistrationCount'] as num?)?.toInt() ?? 0,
  approvedRegistrationCount:
      (json['approvedRegistrationCount'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$ActivityToJson(Activity instance) => <String, dynamic>{
  ...
  'pendingRegistrationCount': instance.pendingRegistrationCount,
  'approvedRegistrationCount': instance.approvedRegistrationCount,
